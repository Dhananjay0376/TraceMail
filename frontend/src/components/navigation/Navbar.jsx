          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 p-0.5 rounded-full border border-white/10 hover:border-white/20 bg-[#0b1026] transition-all cursor-pointer"
              >
                <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-redrob-blue to-redrob-violet flex items-center justify-center text-white font-mono text-[10px] font-bold">
